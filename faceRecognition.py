...
while True:
	...
	if key == ord("q"):
     #here we check that if the names list is empty the it will show Unknown in the terminal.
		if len(names)==0:
			Name='UNKNOWN!!!! {upside-down face}'
		else:
			Name=names[0]
		break
...
#sending the name of the person to file
f=open("/home/sharwan/Desktop/face_recognition/name.txt","w")
f.write(Name)
